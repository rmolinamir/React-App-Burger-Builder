### `Burger Builder App`
[Burger Builder App](https://my-react-burger-builder-app.firebaseapp.com/`)

My course project for the React.js bootcamp I was part of.
Fullstack Developer, React Js, React-Router-Dom, React-Redux · Fake burger builder app, built to learn react advanced features.

Learned very strong React fundamentals, grew accustomed to the lifecycle which is the main factor to develop a great React app. Learned testing, through Enzyme, Jest, and React-Test-Renderer.
